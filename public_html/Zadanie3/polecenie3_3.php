...
<body>
    ...
    <div class="container">
        <div class="text-center mt-5">
            <?php
            $ip = gethostbyname('mikolajkwiatkowski.eu');
            echo 'adres serwera:'. $ip . '<BR />';
            $ip = $_SERVER["REMOTE_ADDR"];
            echo 'adres klienta: '. $ip . '<BR />';
            $hostname = gethostbyaddr("8.8.8.8");
            echo 'adres skojarzony z danym ip: '.$hostname . '<BR />';
            $hostname = gethostbyaddr($_SERVER['REMOTE_ADDR']);
            echo 'nazwa domenowa hosta gościa portalu: '.$hostname;
            ?>
