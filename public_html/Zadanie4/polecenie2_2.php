    ...
    <html lang="en">
        ...
        <body>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="polecenie2_2.php">Usun hosta/a></li>
                                <li>
                                    <hr class="dropdown-divider" />
                                </li>
            ...
            <div class="container">
                ...
                <form  method="post" action="usun_hosta.php" enctype="multipart/form-data">
                        ...
                        <button class="w-50 btn btn-primary btn-lg" type="submit">Usuń</button>
                    </form>
