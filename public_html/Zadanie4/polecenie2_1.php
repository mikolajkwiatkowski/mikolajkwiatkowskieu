    ...
    <html lang="en">
        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container">
                    <a class="navbar-brand" href="panelZalogowany.php">Zadanie 4</a>
            ...
            <div class="container">
                <div class="text-center mt-5">
                    <form  method="post" action="dodaj_hosta.php" enctype="multipart/form-data">
                        ...
                        <button class="w-50 btn btn-primary btn-lg" type="submit">Dodaj</button>
                    </form>
                </div>
            </div>
            <!-- Bootstrap core JS-->
