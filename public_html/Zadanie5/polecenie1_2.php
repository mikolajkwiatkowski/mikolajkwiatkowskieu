                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="polecenie1_2.php">phpinfo()</a></li>
                                    <li><a class="dropdown-item" href="polecenie2_1.php">whoami</a></li>
                                    <li><a class="dropdown-item" href="polecenie2_2.php">RAM, ilosc procesorów</a></li>                          
                                    <li><a class="dropdown-item" href="polecenie3_1.php">lista plików</a></li>
                                    <li><hr class="dropdown-divider" /></li>
                                    <li><a class="dropdown-item" href="polecenie3_2.php">dns_get_record()</a></li>
                                    <li><a class="dropdown-item" href="polecenie3_3.php">gethostbyname()</a></li>
                                    <li><a class="dropdown-item" href="polecenie3_4.php">lokalizacja klienta</a></li>
                                    <li><hr class="dropdown-divider" /></li>
